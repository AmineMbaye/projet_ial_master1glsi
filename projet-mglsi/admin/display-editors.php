...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="administ.php">Administration</a>
    </nav>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $user['prenom'] ?></td>
                      <td><?= $user['login'] ?></td>
                      <td><?= substr($user['password'], 0, 2) . '...' ?></td>
                      <td><?= $user['profil'] ?></td>
                      <td><a href="update.html" class="btn btn-secondary"><i class="fas fa-user-edit"></i>Edit</a></td>
                      <td><a href="#delete" class="btn btn-danger"><i class="fas fa-user-times"></i>Delete</a></td>
                    </tr>
                    <?php } ?>
            ...
            <div class="card-footer small text-muted">Dernière mise à jour ...date...heure...</div>
          </div>
